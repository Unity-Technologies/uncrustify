...
5    [SEMICOLON]         ;
5    [NEWLINE]           
1    [COMMENT_MULTI]     /**␤ * CFoo␤ * TODO: DESCRIPTION␤ * @param arg TODO␤ * ��@return TODO␤ */
5    [NEWLINE]           
...
10   [SEMICOLON]         ;
10   [NEWLINE]           
1    [COMMENT_MULTI]     /**␤ * foo3␤ * TODO: DESCRIPTION␤ * @param ch TODO␤ * ��@param xx TO␤ * O␤@return TODO␤ */
5    [NEWLINE]           
11   [TYPE]              int
11   [FUNC_DEF]          foo3
11   [FPAREN_OPEN]       (
...
17   [BRACE_CLOSE]       }
17   [NEWLINE]           
1    [COMMENT_MULTI]     /**␤ * ~CFoo␤ * TODO: DESCRIPTION␤ * @return TODO␤ */
5    [NEWLINE]           
19   [TYPE]              CFoo
19   [DC_MEMBER]         ::
19   [DESTRUCTOR]        ~
