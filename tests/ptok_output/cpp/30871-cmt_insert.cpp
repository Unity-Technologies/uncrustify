...
5    [FUNC_CLASS_PROTO]    ;
5    [NONE]              
1    [COMMENT_WHOLE]     /**␤ * CFoo␤ * TODO: DESCRIPTION␤ * @param arg TODO␤ * ��@return TODO␤ */
5    [NONE]              
6    [NONE]              CFoo
6    [FUNC_CLASS_DEF]    (
6    [NONE]              char
...
10   [FUNC_PROTO]        ;
10   [NONE]              
1    [COMMENT_WHOLE]     /**␤ * foo3␤ * TODO: DESCRIPTION␤ * @param ch TODO␤ * ��@param xx TO␤ * O␤@return TODO␤ */
5    [NONE]              
11   [FUNC_DEF]          int
11   [NONE]              foo3
11   [FUNC_DEF]          (
...
17   [FUNC_CLASS_DEF]    }
17   [NONE]              
1    [COMMENT_WHOLE]     /**␤ * ~CFoo␤ * TODO: DESCRIPTION␤ * @return TODO␤ */
5    [NONE]              
19   [NONE]              CFoo
19   [NONE]              ::
19   [NONE]              ~
